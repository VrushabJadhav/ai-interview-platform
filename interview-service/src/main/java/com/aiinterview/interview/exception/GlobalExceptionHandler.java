package com.aiinterview.interview.exception;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({IllegalArgumentException.class, IllegalStateException.class}) ResponseEntity<ErrorResponse> bad(RuntimeException ex, HttpServletRequest req) {
